        ...
        <div class="container text-sm-left text-md-left font-weight-normal">
            <div class="row">
                <div class ="col-md-4 col-lg-2">
                    <h6 class="text-uppercase heads fonts font-weight-normal blue py-4">Why ibinex</h6>
...
<footer class="footer page-footer font-small stylish-color-dark">
    ...
    <div class="container text-left text-md-left">
        <div class="row alignment">
            ...
            <!--Second column-->
            <div class="col-sm-12 col-md-5 col-lg-4 position-absolute" style="padding-left: 17%;">
                <div class="position-absolute pt-lg-3 height-foot">
                    <h6 class="text-uppercase font-weight-light fonts grey">Ibinex Offices</h6>
                </div>
                <div class="pad-top" id="pad-left" style="padding-left: 3px;">
                    <ul class="list-unstyled">
                        <li>
            ...
            <!--Third column-->
            <div class="col-sm-12 col-md-4 col-lg-4 column2" style="padding-left: 18%">
